...
FFmpegEncoder::FFmpegEncoder(const char* filename, int theWidth, int theHeight, int fps, const char* preset, const char* crf, QOpenGLContext* mainContext, GLuint id) :
    width { theWidth },
    height { theHeight },
    context { mainContext },
    textureID { id }
